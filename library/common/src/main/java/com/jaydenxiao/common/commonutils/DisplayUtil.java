...
public class DisplayUtil {
    ...
    public static int px2dip(float pxValue) {
        final float scale = BaseApplication.get().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float fontScale = BaseApplication.get().getResources().getDisplayMetrics().scaledDensity;
