package com.geecity.hospital.widget;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
     ...
     * 是否显示图标
     */
    private boolean showExpandCollapseDrawable = false;
    ...
    private void init(AttributeSet attrs) {
         ...
         * 是否显示图标
         */
        showExpandCollapseDrawable = typedArray.getBoolean(R.styleable.ExpandableTextView_showExpandCollapseDrawable, false);

        if (showExpandCollapseDrawable) {
            if (mExpandDrawable == null) {
                mExpandDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_arrow_down);
            }
            if (mCollapseDrawable == null) {
                mCollapseDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_arrow_up);
            }
        }
